...
def main():
    ...
    st.write('Upload an image that you think fits into one of the cifar10 classes and see if the prediction is correct')
    ...
    if file:
        ...
        model = tf.keras.models.load_model('saved_models/cifar10_model.h5')
